...
while True:
    ...
    if neokey[1] and not key_1_state:
        ...
        # raise hand
        keyboard.send(Keycode.COMMAND, Keycode.SHIFT, Keycode.B)
        # update key state
        time.sleep(0.25)
        key_1_state = True
    ...
    if neokey[2] and not key_2_state:
        ...
        # raise hand
        keyboard.send(Keycode.COMMAND, Keycode.SHIFT, Keycode.O)
        # update key state
        time.sleep(0.25)
        key_2_state = True
    ...
    if neokey[3] and not key_3_state:
        ...
        # ABORT
        keyboard.send(Keycode.COMMAND, Keycode.SHIFT, Keycode.M)
        # update key state
        time.sleep(0.25)
        key_3_state = True
